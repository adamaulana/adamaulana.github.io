let  bahasa = {
    ...
    "indo" :{
        ...
        "desc"              : "Seiring berkembangnya zaman, industri ini sadar akan pentingnya keseimbangan  ekosistem pada hutan Indonesia. ISPO atau Indonesian Sustainable Palm Oil pun akhirnya diciptakan pada tahun 2001.Principle and Criteria ISPO untuk Sustainable Palm Oil Production ( P&C ISPO ) merupakan panduan global untuk produksi minyak sawit secara berkelanjutan di Indonesia. Sertifikasi ini muncul karena kekhawatiran akan dampak buruk yang akan terjadi kedepannya atas ekosistem, keanekaragaman hayati dan peningkatan efek rumah kaca yang akan terjadi di Indonesia nantinya. Kelapa sawit bukanlah sebuah industri ataupun aktivitas jahat yang hanya membawa dampak negatif ke masyarakat. Industri kelapa sawit memiliki banyak sekali POTENSI yang menguntungkan. <span class=\"mybolder\">JIKA DIOLAH DENGAN BENAR !</span>",
